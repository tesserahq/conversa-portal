...
function Switch({ className, ...props }: React.ComponentProps<typeof SwitchPrimitive.Root>) {
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        `peer border-input focus-visible:border-ring focus-visible:ring-primary/50
      ...
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          dark:data-[state=unchecked]:bg-foreground pointer-events-none block size-4 rounded-full
